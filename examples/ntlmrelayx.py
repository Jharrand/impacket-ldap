...
def start_servers(options, threads):
    for server in RELAY_SERVERS:
        ...
        c.setLDAPOptions(options.no_dump, options.no_da, options.no_acl, options.no_validate_privs, options.escalate_user, options.add_computer, options.computer_container, options.delegate_access, options.dump_laps, options.dump_gmsa, options.dump_adcs, options.sid, options.add_dns_record)
...
if __name__ == '__main__':
    ...
    ldapoptions.add_argument('--computer-container', action='store', required=False, help='Manually set the base OU for adding a computer')
